...
data_specific <-
  paste(
    ...
    "Also included is partial F and proportion of the total catch in numbers by stock and age for various fleet components.  Three gear groupings are provided, from a high level, describing the type of fishing (e.g. Otter trawl, pelagic trawl), a more detailed grouping based on metier level 4 codes, and a more detailed still based on metier level 5.  Metier level 5 is provided in case the user wished to construct thier own fleet grouping."
  )
